...
export function TourDeparturePlacesPage() {
  ...
  const canCreate = hasPermission('tour-departure-places.create');
  const canUpdate = hasPermission('tour-departure-places.update');
  const canDelete = hasPermission('tour-departure-places.delete');
  const canUpdateStatus = hasPermission('tour-departure-places.status');
