...
class RolePermissionSeeder extends Seeder
{
    ...
    private function permissionGroups(): array
    {
        return [
            ...
            'apartmentTypes' => ['apartment-types.viewAny', 'apartment-types.view', 'apartment-types.create', 'apartment-types.update', 'apartment-types.delete', 'apartment-types.status'],
