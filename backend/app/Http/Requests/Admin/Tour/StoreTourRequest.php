...
class StoreTourRequest extends FormRequest
{
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'booking_form_template_id' => $this->input('booking_form_template_id', $this->input('bookingFormTemplateId')),
    ...
    public function rules(): array
    {
        return [
            ...
            'seo_name' => ['nullable', 'string', 'max:255', Rule::unique('tours', 'seo_name')],
            ...
            'booking_form_template_id' => ['nullable', 'integer', 'exists:booking_form_templates,id'],
